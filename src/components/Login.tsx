            ...
            <form>
                ...
                <div>
                    ...
                    <div className="relative">
                        <input type="password" className="block w-full p-4 bg-white border-2 border-black text-gray-900 text-sm rounded-lg" required/>
                        <button className="text-black absolute end-0.5 bottom-2.5 text-sm px-4 py-1">
