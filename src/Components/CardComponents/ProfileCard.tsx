...
const ProfileCard = ({user, discovery = false}) => {
    ...
    return (
        ...
        <div className="relative bg-white p-4 rounded-lg sm:w-3/4 md:w-5/6 flex flex-col gap-4 border-2 border-black">
            ...
            {!profileView ? (
                ...
                <div className={`flex flex-col gap-4`}>
                    ...
                    <div className={`flex`}>
                        ...
                        <div className={"flex flex-col w-full"}>
                            <div className="flex items-center space-x-2">
                                ...
                                {!discovery &&
                                    <p className={`font-bold text-xs sm:text-lg ${LinkPercentageColor(profileData.compatibilityScore)}`}>
                    ...
                    <div className={"flex justify-between"}>
                        <div>
                            <h3 className="sm:mt-4 font-bold m:1 sm:m-2  text-xs sm:text-xl">About Me</h3>
                            <p className="text-gray-600 text-xs sm:text-lg sm:m-2 sm:font-normal">{profileData.profileData.bio}</p>
                            <h3 className="sm:mt-4 font-bold m:1 mt-2 sm:m-2 text-xs sm:text-xl">Hobbies/Interests</h3>
                ...
                <div className={`flex gap-4 `}>
                    ...
                    <div className={`flex flex-col`}>
                        <img onClick={navigateToProfile}
                             src={profileData.profileData.profile_picture ? imgUrl + profileData.profileData.profile_picture :
                                 "https://archive.org/download/instagram-plain-round/instagram%20dip%20in%20hair.jpg"}
                             alt="Profile"
                             className={`sm:w-28 sm:h-28 w-12 h-12 rounded-3xl sm:rounded-md cursor-pointer`}/>
                        ...
                        <div className={"flex flex-col w-full"}>
                            ...
                            {/*Property info*/}
                            <div className="flex flex-col items-start">
                                <p className="text-gray-500 text-xs sm:text-xl sm:font-semibold">Age: {profileData.profileData.age}</p>
                                <p className="text-gray-500 text-xs sm:text-xl sm:font-semibold">${profileData.personalData.budget}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex-1">
                            ...
                            <div className="flex flex-col">
                                <div>
                                    ...
                                    <div className={"flex items-center space-x-2"}>
                                        ...
                                        <p className="text-gray-600 text-xs sm:text-sm">{profileData?.propertyData.bedroom_count} Bedroom
                                        ...
                                        {!discovery &&
                                            <>
                                                ...
                                                <h4 className={`text-center text-xs sm:text-xl font-semibold ${getTextColor(profileData.distance)}`}>
                        ...
                        <div>
                            <p className="text-gray-700 text-xs sm:text-sm mt-2 w-[150px] sm:w-[450px] truncate">
                                {profileData.propertyData.description}
                            </p>
                        </div>
                    </div>
                </div>
