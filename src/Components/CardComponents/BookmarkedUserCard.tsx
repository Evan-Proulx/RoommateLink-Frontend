                ...
                <div className="flex flex-col w-fit space-y-1">
                    ...
                    <div className="flex justify-between items-center">
                        <div className="flex items-center space-x-2">
                            <h4 onClick={navigateToProfile} className="font-extrabold text-3xl cursor-pointer hover:underline">{profileData.profileData.first_name + " " + profileData.profileData.last_name}</h4>
