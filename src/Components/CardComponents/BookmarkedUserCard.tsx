                    ...
                    <div className="relative cursor-pointer" onClick={navigateToProfile}>
                        ...
                        {Boolean(profileData.personalData.has_housing) && (
                            <img
                                ...
                                alt="Profile"
                                className="absolute sm:bottom-8 bottom-2 right-0 h-8 w-8  sm:w-16 sm:h-16 rounded-full border-2 border-blue-600 transform translate-y-1/2 translate-x-1/2"
                            />
                        )}
                    </div>
                </div>
