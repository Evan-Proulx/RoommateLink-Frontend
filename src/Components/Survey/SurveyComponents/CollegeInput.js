...
const CollegeInput = ({ onSchoolChange, customStyles = {} }) => {
    ...
    return (_jsx(Select, { styles: { ...defaultStyles, ...customStyles }, classNamePrefix: "select", options: colleges, isLoading: isLoading, isClearable: true, isSearchable: true, name: "colleges", value: selectedCollege, onChange: handleSetSchool }));
};
