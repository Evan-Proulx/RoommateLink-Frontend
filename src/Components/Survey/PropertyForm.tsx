            ...
            <form className={"pt-12 space-y-8"}>
                ...
                <div className="flex flex-col items-center justify-center w-full">
                    ...
                    <label htmlFor="dropzone-file"
                           className="flex flex-col items-center justify-center w-full h-64 border-2 border-text border-dashed rounded-lg cursor-pointer hover:bg-[var(--color-primary-hovered)] transition duration-200 ease-in-out">
                        <div className="flex flex-col items-center justify-center pt-5 pb-6">
                            ...
                            <p className="mb-2 text-sm text-text"><span
