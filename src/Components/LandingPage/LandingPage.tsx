...
const FirstSection = () => {
    ...
    const handleOpenPopup = () => {
        ...
        // If the user isnt authenticated prompt them to sign in
        //Otherwise navigate to the feed
        if (!token) {
            setPopupOpen(true);
        }else{
            navigate('/feed');
    ...
    return (
        <section
            className="bg-gradient-to-r from-white to-yellow-100 text-center pb-10 pl-5 pr-5 md:pl-10 md:pr-10 lg:pl-20 lg:pr-20">
            <div className="flex justify-between items-center w-full py-4 px-5 md:px-10 lg:px-20">
                ...
                <div className="flex items-center space-x-3">
                    ...
                    <label className="relative inline-flex items-center cursor-pointer">
                        ...
                        />
                        <div
                            className="w-12 md:w-14 h-6 md:h-7 bg-red-500 rounded-full peer-checked:bg-blue-400 transition-colors duration-300">
                            <div
            ...
            <div className="flex flex-col items-center justify-center text-center mt-6 md:mt-0">
                ...
                <h1 className="text-xl md:text-3xl font-bold text-red-600 mt-2 md:mt-[-20px] lg:text-4xl">Find the
                    Perfect Roommate or Place with Ease!</h1>
                        ...
                        <div
                            ...
                            <div className="p-2">
                                <p className="text-lg md:text-xl font-normal text-red-600 lg:text-1xl">
                                    Easily find a like-minded roommate or the perfect place with our smart matching
                                    system. Hassle-free, fast, and tailored to your lifestyle.
                                </p>
                            </div>
                        </div>
                        <div
                            ...
                            <div className="p-2">
                                <p className="text-lg md:text-xl font-normal text-red-600 lg:text-1xl">
                                    Stay safe with verified listings and secure chats. Join thousands who found their
                                    ideal living situation—quick, easy, and stress-free!
                                </p>
                            </div>
                        </div>
                        <div
                            ...
                            <div className="p-2">
                                <p className="text-lg md:text-xl font-normal text-red-600 lg:text-1xl">
                                    Find your next home effortlessly and start living comfortably with a roommate who
                                    truly matches your vibe!
                                </p>
                            </div>
                        </div>
                    </div>
...
const HowItWorks = () => {
    ...
    return (
        <section
            className="bg-gradient-to-r from-white to-yellow-100 text-center py-8 md:py-10 pl-5 pr-5 md:pl-0 md:pr-0 lg:pl-10 lg:pr-10">
            ...
            <div className="mt-4 flex flex-col lg:flex-row items-center justify-center gap-6">
                ...
                <div className="flex flex-col gap-4 md:gap-6 max-w-md lg:max-w-lg lg:order-2">
                    <div onClick={handleOpenPopup}
                        className="bg-yellow-100 p-4 md:p-6 rounded-lg shadow-2xl bg-gradient-to-r from-yellow-100 to-white transition-transform duration-300 hover:scale-105 cursor-pointer">
                        <div className="flex items-left gap-2">
                            <FontAwesomeIcon icon={faUser} className="text-xl md:text-2xl text-red-600 lg:text-3xl"/>
                            <h3 className="text-lg md:text-xl font-bold text-left text-red-600 lg:text-2xl">Create Your
                                Profile</h3>
                        </div>
                        <p className="text-gray-700 mt-2 text-sm md:text-base text-left lg:text-lg">Tell us about
                            yourself and what you're looking for.</p>
                    </div>
                    <div
                        className="bg-yellow-100 p-4 md:p-6 rounded-lg shadow-2xl bg-gradient-to-r from-yellow-100 to-white transition-transform duration-300 hover:scale-105">
                        <div className="flex items-left gap-2">
                            <FontAwesomeIcon icon={faMagnifyingGlassPlus}
                                             className="text-xl md:text-2xl text-red-600 lg:text-3xl"/>
                            <h3 className="text-lg md:text-xl font-bold text-left text-red-600 lg:text-2xl">Discover
                                Matches</h3>
                        </div>
                        <p className="text-gray-700 mt-2 text-sm md:text-base text-left lg:text-lg">Get matched with
                            compatible roommates or listings.</p>
                    </div>
                    <div
                        className="bg-yellow-100 p-4 md:p-6 rounded-lg shadow-2xl bg-gradient-to-r from-yellow-100 to-white transition-transform duration-300 hover:scale-105">
                        <div className="flex items-left gap-2">
                            <FontAwesomeIcon icon={faComments}
                                             className="text-xl md:text-2xl text-red-600 lg:text-3xl"/>
                            <h3 className="text-lg md:text-xl font-bold text-left text-red-600 lg:text-2xl">Connect &
                                Move In</h3>
                        </div>
                        <p className="text-gray-700 mt-2 text-sm md:text-base text-left lg:text-lg">Chat securely,
                            schedule visits, and finalize your plans.</p>
                    </div>
                    <LoginPopup isOpen={isPopupOpen} onClose={handleClosePopup}/>
                </div>
            </div>
    ...
    return (
        <section className="py-12 md:py-16 text-center bg-gradient-to-r from-white to-yellow-100">
            ...
            <div className="mt-4 flex flex-col md:flex-row justify-center gap-4 md:gap-6 max-w-6xl mx-auto lg:gap-8">
                <div
                    className="bg-yellow-100 p-6 md:p-10 rounded-lg shadow-2xl w-full max-w-sm transition-transform duration-300 hover:scale-105 self-center">
                    <h3 className="text-xl md:text-2xl p-2 font-bold text-red-600 lg:text-3xl">Smart Matching</h3>
                    <p className="text-gray-700 mt-2 text-sm md:text-base lg:text-lg">Algorithm that connects you with
                        ideal roommates.</p>
                </div>
                <div
                    className="bg-white p-6 md:p-10 rounded-lg shadow-2xl w-full max-w-sm bg-gradient-to-r from-yellow-100 to-white transition-transform duration-300 hover:scale-105 self-center">
                    <h3 className="text-xl md:text-2xl p-2 font-bold text-red-600 lg:text-3xl">Budget-Friendly</h3>
                    <p className="text-gray-700 mt-2 text-sm md:text-base lg:text-lg">Filter by rent, location, and
                        amenities.</p>
                </div>
                <div
                    className="bg-white p-6 md:p-10 rounded-lg shadow-2xl w-full max-w-sm transition-transform duration-300 hover:scale-105 self-center">
                    <h3 className="text-xl md:text-2xl p-2 font-bold text-red-600 lg:text-3xl">Verified Listings</h3>
                    <p className="text-gray-700 mt-2 text-sm md:text-base lg:text-lg">No scams, only real people &
                        places.</p>
                </div>
            </div>

            <div className="flex flex-col items-center justify-center text-center space-y-4 mt-6 md:mt-8">
                <h2 className="text-lg md:text-xl px-4 py-2 font-bold text-red-600 lg:text-2xl">So, What are you waiting
                    for?</h2>
                <div onClick={handleOpenPopup}>
    ...
    return (
        <div>
            ...
            <footer className="text-center py-4 md:py-6 bg-red-600 text-white">
                <div
                    className="mb-4 md:mb-5 flex flex-row md:flex-row justify-center items-center space-y-2 md:space-y-0 md:space-x-8 lg:space-x-16">
                    <button
