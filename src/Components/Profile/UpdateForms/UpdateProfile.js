...
const UpdateProfile = ({ closeModal }) => {
    ...
    return (_jsxs("div", { className: "flex flex-col justify-center items-center border-2 border-black p-10 w-full rounded-lg", children: [_jsx("h1", { className: "header2-text pb-3", children: "Update your profile info" }), _jsx(FormProvider, { ...methods, children: _jsxs("form", { onSubmit: handleUpdateProfile, className: "space-y-12", children: [_jsxs("section", { className: "", children: [_jsx("label", { htmlFor: "cities", className: "block header4-text text-start", children: "Please select your city*" }), _jsxs("div", { className: "flex items-center justify-center space-x-2", children: [_jsx("input", { id: "location", value: locationName, readOnly: true, contentEditable: false, className: "input-style-survey" }), _jsx("button", { type: "button", className: "bg-text p-3 rounded text-white transition-all duration-200 hover:rounded-2xl hover:bg-red-800", onClick: () => setIsMapOpen(true), children: _jsx(LocationSearching, {}) }), _jsx(MapPopup, { isOpen: isMapOpen, onClose: () => setIsMapOpen(false), latitude: defaultLocation.latitude, longitude: defaultLocation.longitude, onRadiusChange: handleRadiusChange, onLocationChange: handleLocationChange })] })] }), _jsxs("div", { className: "relative mb-6 ", children: [_jsxs("label", { htmlFor: "budget", className: "block mb-2 header4-text text-start", children: ["Rent Budget: $", updatedPersonalData?.budget, "/month"] }), _jsx("input", { id: "budget", type: "range", min: "100", max: "10000", step: "100", defaultValue: updatedPersonalData?.budget, className: "w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer dark:bg-gray-700", onChange: (e) => {
                                        updatePersonalData("budget", parseInt(e.target.value));
                                    } }), _jsx("span", { className: "text-sm text-gray-500 dark:text-gray-400 absolute start-0 -bottom-6", children: "$100" }), _jsx("span", { className: "text-sm text-gray-500 dark:text-gray-400 absolute start-1/3 -translate-x-1/2 rtl:translate-x-1/2 -bottom-6", children: "$500" }), _jsx("span", { className: "text-sm text-gray-500 dark:text-gray-400 absolute start-2/3 -translate-x-1/2 rtl:translate-x-1/2 -bottom-6", children: "$1000" }), _jsx("span", { className: "text-sm text-gray-500 dark:text-gray-400 absolute end-0 -bottom-6", children: "$10000" })] }), _jsxs("section", { className: "flex justify-center items-end space-x-3", children: [_jsxs("div", { className: "flex flex-col ", children: [_jsx("label", { htmlFor: "firstname", className: "block mb-2 header4-text", children: "First Name" }), _jsx("input", { type: "input", id: "firstname", name: "firstname", value: updatedProfileData?.first_name, min: 2, max: 50, required: true, className: "input-style-survey", ...register("firstname", {
