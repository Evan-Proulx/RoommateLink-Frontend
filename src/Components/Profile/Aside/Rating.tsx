function Rating() {
    ...
    return (
        <div className=" pb-5">
            ...
            <label className="bg-blue-600 text-white font-semibold shadow-btn px-4 pb-2 w-fi m-1">
                Friendly
            </label>
            <label className="bg-blue-600 text-white font-semibold shadow-btn px-4 w-fit pb-2 m-1">
                Clean
            </label>
        </div>
        </div>
