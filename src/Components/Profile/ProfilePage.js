...
function ProfilePage() {
    ...
    return (_jsx(ProfileContext.Provider, { value: profileData, children: _jsxs("div", { className: "flex flex-col h-screen overflow-y-hidden", children: [_jsx(Navbar, {}), _jsx("div", { className: "flex justify-center bg-primary", children: _jsxs("div", { className: "items-center overflow-y-auto h-screen bg-profile xl:w-2/3 shadow-2xl", children: [_jsx(UserInfoSection, { myProfileDisplayed: myProfileDisplayed }), _jsxs("div", { className: "flex", children: [_jsx(Aside, { myProfileDisplayed: myProfileDisplayed }), _jsx(AboutSection, { propertyImages: propertyImages, myProfileDisplayed: myProfileDisplayed, interestedPeople: interestedUsers })] })] }) })] }) }));
}
