...
function AboutSection({ propertyImages, myProfileDisplayed, interestedPeople }) {
    ...
    return (_jsxs("div", { className: "p-4", children: [_jsxs("div", { className: "flex space-x-6 mt-2", children: [_jsx("button", { onClick: () => setActiveTab("about"), className: `px-4 py-2 cursor-pointer ${activeTab === "about" ? "border-b-4 border-black text-3xl font-bold" : "text-xl"}`, children: "About Me" }), (Boolean(user.personalData.has_housing) || myProfileDisplayed) &&
