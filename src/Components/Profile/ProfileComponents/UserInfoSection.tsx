            ...
            <div className="w-1/2 pr-4">
                <div>
                    ...
                    <div className="flex items-center m-3">
                        <h1 className="text-5xl font-bold text-center">John Lastname</h1>
                        <svg className="w-10 h-10 text-gray-800 dark:text-blue-700" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
